...
if (!isset($_SESSION['logged_in']) || $_SESSION['logged_in'] !== true) {
    header("Location: login-page.php"); // ถ้ายังไม่ได้ล็อกอิน ให้กลับไปหน้าล็อกอิน
    exit();
}
...
$fa_de_name = htmlspecialchars($_SESSION['fa_de_name'] ?? 'N/A'); // ชื่อคณะ/หน่วยงาน
        ...
        <div class="row justify-content-center">
            <div class="col-md-8 col-lg-6">
                <div class="profile-card">
                    <h2 class="mb-4">ข้อมูลโปรไฟล์ผู้ใช้</h2>
