...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 01, 2025 at 08:13 PM
...
('11', 'โรงกรองน้ำและหอวิทยาเขต', 'images/buildings/68b5e0d64fd85.jpg'),
...
(13, '2025-09-01', '2025-09-01', '', 'ส่งคำร้องขอ', '1', '1', '2025-09-01 10:45:40.521313', 'ไม่อนุมัติ', '2025-09-01', 3, 'อุปกรณ์หมด', 19, 8, 7, 's5610003145');
...
(26, '09:00:00', '12:00:00', '2025-08-31', '2025-09-01', '13:00:00', '18:00:00', '2025-09-01', '2025-09-01', '', 'เริ่มดำเนินการ', '0', '2025-09-01 10:45:48.243829', 'อนุมัติ', '2025-09-01', NULL, 19, 7, 's5610003145'),
(27, '09:00:00', '18:00:00', '2025-09-22', '2025-09-23', '09:00:00', '18:00:00', '2025-09-23', '2025-09-23', '', 'ส่งคำร้องขอ', '1', '2025-09-01 10:55:07.257937', 'อนุมัติ', '2025-09-01', NULL, 20, 9, 's5610003145');
...
(20, 'โหมโรง ทรงเครื่อง', '2025-09-22', '2025-09-23', 'โหมโรงไทย ใจรัก', '', '100', '0987654321', 'Jesus J.', '2025-09-01 10:40:59.344614', 'ส่งโครงการ', 'b6540201149', 2);
...
--
ALTER TABLE `facilities_requests`
  MODIFY `facility_re_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;
...
--
ALTER TABLE `project`
  MODIFY `project_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;
