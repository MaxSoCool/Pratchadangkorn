...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql_user = "SELECT user.user_id, user.user_pass, user_THname, user_THsur, user_ENname, user_ENsur, user_type.user_type_name AS role, faculties_department.fa_de_name FROM user
